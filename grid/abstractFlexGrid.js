...
import {ReactiveDataItemDefinition} from "../react/reactiveDataItemDefinition.js";
import {ReactiveParentDefinition} from "../react/reactiveParentDefinition.js";
        ...
        this.reactivator = new Reactivator(
            {
                ...
                // callbacks: {
                //     direct: function(propName){
                //         !(propName in this.globalStorage.callbacks.ds) &&
                //         (
                ...
                //             this.globalStorage.callbacks.g[propName] = this.createGetterCallback(propName),
                //             this.globalStorage.callbacks.ds[propName] = this.createDirectSetterCallback(propName)
                //         );
                //
                //         return {
                //             g: this.globalStorage.callbacks.g[propName],
                //             ds: this.globalStorage.callbacks.ds[propName]
                //         }
                //     }.bind(this),
                //     reverse: function(propName){
                //         !(propName in this.globalStorage.callbacks.rs) &&
                //         (
                //             //Свойство с таким наименованием еще не конфигурировалось как direct
                //             //При этом высока вероятность, что Getter для него тоже еще не создавался, т.к. вероятность
                //             // одновременного использования свойства как direct и reverse не очень высока
                ...
                //             //Такой подход позволяет сократить число проверок существования callback'ов для propName
                //             this.globalStorage.callbacks.g[propName] = this.createGetterCallback(propName),
                //             this.globalStorage.callbacks.rs[propName] = this.createReverseSetterCallback(propName)
                //         );
                //
                //         return {
                //             g: this.globalStorage.callbacks.g[propName],
                //             rs: this.globalStorage.callbacks.rs[propName]
                //         }
                //     }.bind(this)
                // }
            }
...
//
//         // let cnf = {
//         //     entityParentField: this.directParentFields,
//         //     events: {
//         //         beforeItemChange: this.events.beforeItemChange,
//         //         beforeChildItemChange: this.events.beforeChildItemChange,
//         //         itemChange: this.events.itemChange,
...
//         //                 //Такой подход позволяет сократить число проверок существования callback'ов для propName
//         //                 this.globalStorage.callbacks.g[propName] = this.createGetterCallback(propName),
//         //                 this.globalStorage.callbacks.rs[propName] = this.createDirectSetterCallback(propName)
//         //             );
//         //
//         //             return {
//         //                 g: this.globalStorage.callbacks.g[propName],
...
//          */
//
//         this.createGridStorageIntoObject(dataItem);//beforeEntityReactivation
//
//         /**

(function(){
    ...
    function FlexGridPanel (config) {
        ...
        pub = {
            setStyle: function(propName, propValue){
            ...
            addItemAfter: function (key, item, after){
            ...
            addItemBefore: function (key, item, before){
            ...
            addItemBefore: function (key, item, /** @type {number} */ position){
            ...
            draggable: function(/** @type {boolean} */ flag){
                //Можно ли перемещать панель
            },
            droppable: function(/** @type {boolean} */ flag){
